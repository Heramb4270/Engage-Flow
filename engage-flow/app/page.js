        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold">EngageFlow</span>
            </div>
            <div className="hidden md:flex space-x-8">
              <Link href="#features" className="hover:text-indigo-400 transition-colors">Features</Link>
              <Link href="#dashboard" className="hover:text-indigo-400 transition-colors">Ai Analysis</Link>
              <Link href="#team" className="hover:text-indigo-400 transition-colors">Ai assistance</Link>
            </div>
            <Link href="/signup" 
        ...
        <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            >
              ...
              <br />
              <span className="text-4xl md:text-6xl">with Langflow Integration</span>
            </motion.h1>
            ...
            >
              <Link
                ...
                className="bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 
                  px-8 py-4 rounded-full text-lg font-semibold transition-all transform hover:scale-105"
              >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              {features.map((feature, index) => (
                <motion.div
                  key={index}
                  className="bg-gray-800/80 backdrop-blur-md p-8 rounded-2xl hover:bg-gray-700/80 
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              <div className="text-center mb-12">
                <h2 className="text-4xl font-bold mb-4">Powerful Analytics Dashboard</h2>
                <p className="text-xl text-gray-300">Track, analyze, and optimize your social media performance</p>
              </div>
              
              <div className="bg-gray-900 rounded-xl p-6 shadow-2xl">
                {/* Mock dashboard UI - Replace with actual dashboard components */}
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                  <div className="bg-gray-800 p-4 rounded-lg">
                    <TrendingUp className="w-8 h-8 text-green-400 mb-2" />
                    <h4 className="text-lg font-semibold">Engagement Rate</h4>
                    <p className="text-3xl font-bold text-green-400">+24.8%</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-lg">
                    <Users className="w-8 h-8 text-blue-400 mb-2" />
                    <h4 className="text-lg font-semibold">New Followers</h4>
                    <p className="text-3xl font-bold text-blue-400">1,482</p>
                  </div>
                  <div className="bg-gray-800 p-4 rounded-lg">
                    <Rocket className="w-8 h-8 text-purple-400 mb-2" />
                    <h4 className="text-lg font-semibold">Post Reach</h4>
                    <p className="text-3xl font-bold text-purple-400">52.4K</p>
                  </div>
                </div>
              </div>
            </motion.div>
...
<section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/30">
  <div className="max-w-7xl mx-auto">
    ...
    >
      ...
      <p className="text-xl text-gray-300">The innovators behind EngageFlow</p>
    </motion.div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
      {[
        ...
        <motion.div
          key={index}
          className="bg-gray-800/50 p-6 rounded-xl backdrop-blur-md text-center"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <div className="flex justify-center space-x-4">
            <Link href={member.links.linkedin} className="text-gray-400 hover:text-blue-400">
              <Linkedin className="w-5 h-5" />
            </Link>
            <Link href={member.links.github} className="text-gray-400 hover:text-gray-200">
              <Github className="w-5 h-5" />
            </Link>
            <Link href={member.links.twitter} className="text-gray-400 hover:text-blue-400">
        ...
        {/* footer */}
        <footer className="bg-gray-900/80 text-center py-8">
          <div className="max-w-7xl mx-auto">
